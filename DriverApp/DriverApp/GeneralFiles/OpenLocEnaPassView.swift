...
class OpenLocEnaPassView: NSObject, MyBtnClickDelegate, OnLocationUpdateDelegate {
    ...
    var currentInst:OpenLocEnaPassView!
    
    let generalFunc = GeneralFunctions()
    
    var enableLocationView:EnableLocPassView!
    ...
    func show(){
        ...
        enableLocationView = EnableLocPassView(frame: CGRect(x:0, y:0, width: width, height: height - GeneralFunctions.getSafeAreaInsets().bottom ))
        ...
        bgView.frame = CGRect(x:0, y:0, width:Application.screenSize.width, height: height)
        
        bgView.center = CGPoint(x: Application.screenSize.width / 2, y: height / 2)
