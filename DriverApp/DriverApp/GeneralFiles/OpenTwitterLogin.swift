...
//        }
    ...
    func executeProcess(vEmail:String, vFirstName:String, vLastName:String, vFbId:String, vImageURL:String){
        ...
        let parameters = ["type":"LoginWithFB","vEmail": vEmail, "vFirstName": vFirstName,"vLastName": vLastName, "iFBId": vFbId, "vDeviceType": Utils.deviceType, "eLoginType": "Twitter", "UserType": Utils.appUserType, "vCurrency": userSelectedCurrency, "vLang": userSelectedLanguage, "vImageURL": vImageURL]
    ...
    func registerUser(vEmail:String, vFirstName:String, vLastName:String, vFbId:String, vImageURL:String){
        ...
        let parameters = ["type":"signup","vFirstName": vFirstName, "vLastName": vLastName, "vEmail": vEmail, "vFbId": vFbId, "vDeviceType": Utils.deviceType, "vCurrency": userSelectedCurrency, "vLang": userSelectedLanguage, "eSignUpType": "Twitter", "UserType": Utils.appUserType, "vImageURL": vImageURL]
