...
class AddVehiclesUV: UIViewController, MyBtnClickDelegate, BEMCheckBoxDelegate, MyTxtFieldClickDelegate , UITableViewDataSource , UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if(self.eType.uppercased() == Utils.cabGeneralType_Deliver.uppercased() || self.eType.uppercased() == "DELIVERY"){
...
//        }
        ...
        Utils.printLog(msgData: "EEEtype::\(self.eType)")
    }
    ...
    func setData(){
        ...
        if(self.eType.uppercased() != Utils.cabGeneralType_Ride.uppercased()){
            ...
            if(response != ""){
                ...
                if(dataDict.get("Action") == "1"){
                    ...
                    for i in 0..<vehicletypelist.count{
                        ...
                        self.carTypesRentalStatusArr += [false]
                        ...
                        if((self.currentVehicleData != nil && vRentalCarType.contains(item.get("iVehicleTypeId"))) || (item.get("VehicleServiceStatus") != "" && item.get("VehicleServiceStatus") == "true")){
                            self.carTypesRentalStatusArr[i] = true
                        }
                    }
...
//                                    }
                                ...
                                listOfDocumentUV.eType = self.eType
