...
//        self.contentView.addSubview(cntView)
        ...
        if manageVehiUV != nil
        {
            let leftButton: UIBarButtonItem = UIBarButtonItem(image: UIImage(named: "ic_nav_bar_back")!, style: UIBarButtonItemStyle.plain, target: self, action: #selector(self.closeUV))
