...
//        }
        ...
        switch indexPath.item {
        case 0:
            titleHeight = self.generalFunc.getLanguageLabel(origValue: "Registration Successful", key: "LBL_REGISTRATION_SUCCESS").height(withConstrainedWidth: Application.screenSize.width - 85, font: UIFont (name: "Roboto-Light", size: 15)!)
            defaultHeight = 50
            break
        case 1:
        ...
        case 2:
            ...
            if(statusOfStates[indexPath.item] == true){
             ...
             titleHeight = titleTxt.height(withConstrainedWidth: Application.screenSize.width - 85, font: UIFont (name: "Roboto-Light", size: 15)!)
...
//                noteTextHeight = noteTextHeight - 60 - 10
        ...
        case 4:
            ...
            titleHeight = self.generalFunc.getLanguageLabel(origValue: statusOfStates[indexPath.item] == true ? "" : "Waiting for admin's approval", key: statusOfStates[indexPath.item] == true ? "LBL_ADMIN_APPROVE" : "LBL_WAIT_ADMIN_APPROVE").height(withConstrainedWidth: Application.screenSize.width - 85, font: UIFont (name: "Roboto-Light", size: 15)!)
    ...
    func myBtnTapped(sender: MyButton) {
        ...
        if(sender.btnType == "UPLOAD_DOC"){
            if (self.userProfileJson.get("APP_TYPE") == Utils.cabGeneralType_Ride_Delivery_UberX || self.userProfileJson.get("APP_TYPE") == Utils.cabGeneralType_Ride_Deliver){
                ...
                appTypeSelectionUv.screenToNavigate = "UPLOAD_DOC"
                ...
                listOfDocumentUV.eType = self.userProfileJson.get("APP_TYPE")
            ...
            }else if (self.userProfileJson.get("APP_TYPE") == Utils.cabGeneralType_Ride_Delivery_UberX || self.userProfileJson.get("APP_TYPE") == Utils.cabGeneralType_Ride_Deliver){
                let appTypeSelectionUv = GeneralFunctions.instantiateViewController(pageName: "AppTypeSelectionUV") as! AppTypeSelectionUV
                appTypeSelectionUv.isFromDriverStatesUV = true
                appTypeSelectionUv.totalAddedVehicles = totalAddedVehicles
                appTypeSelectionUv.screenToNavigate = self.userProfileJson.get("APP_TYPE") == Utils.cabGeneralType_Ride_Delivery_UberX ? "MANAGE_VEHICLE" : "ADD_VEHICLE"
                self.pushToNavController(uv: appTypeSelectionUv)
            }else{
