...
//        tableView.reloadRows(at: [IndexPath(item: indexPath.item, section: indexPath.section)], with: .none)
    ...
    func updateServices(carTypes:String){
            ...
            let parameters = ["type":"UpdateDriverVehicle","iDriverId": GeneralFunctions.getMemberd(), "UserType": Utils.appUserType, "vCarType": carTypes, "iVehicleCategoryId": iVehicleCategoryId, "eType": Utils.cabGeneralType_UberX]
