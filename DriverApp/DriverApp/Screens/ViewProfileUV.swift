...
//    @IBOutlet weak var countryTxtField: MyTextField!
    @IBOutlet weak var workLocTxtFiledHeightCons: NSLayoutConstraint!
    @IBOutlet weak var workLocTextField: MyTextField!
    ...
    func setData(){
        ...
        {
            self.workLocTxtFiledHeightCons.constant = 50
            self.scrollViewCOntentViewHeight.constant = self.scrollViewCOntentViewHeight.constant + self.workLocTxtFiledHeightCons.constant
            //self.PAGE_HEIGHT = self.PAGE_HEIGHT + 505
            self.workLocTextField.isHidden = false
            workLocTextField.setPlaceHolder(placeHolder: self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_WORKLOCATION"))
            if userProfileJson.get("eSelectWorkLocation") == "Fixed"
            {
                workLocTextField.setText(text: self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_SPECIFIED_LOCATION"))
            }
            else if userProfileJson.get("eSelectWorkLocation") == "Dynamic"
            {
                workLocTextField.setText(text: self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_ANY_LOCATION"))
            }
            
            workLocTextField.setEnable(isEnabled: false)
            workLocTextField.configDivider(isDividerEnabled: false)
            workLocTextField.configHighlighted(isHighLightedEnabled: true)
        }*/
