...
//            cntView.frame = self.contentView.frame
    ...
    func setData(){
        ...
        if(self.userProfileJson.get("APP_TYPE") == Utils.cabGeneralType_Ride_Delivery_UberX){
            self.navigationItem.title = self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_MANANGE_OTHER_SERVICES")
            self.title = self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_MANANGE_OTHER_SERVICES")
        }else{
            self.navigationItem.title = self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_MANANGE_SERVICES")
            self.title = self.generalFunc.getLanguageLabel(origValue: "", key: "LBL_MANANGE_SERVICES")
        }
